...
class TanggapanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pengaduan.index')->with('message','Tanggapan berhasil dilaporkan!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $tanggapan->save();
        return redirect ()->route('pengaduan.index')->with('message', 'Tanggapan berhasil diupdate');
        }
